class Modification {
	constructor(params) {
		...
		this.prefixesEpic = ["Superior", "Ravenous", "Horrific", "Perpetual", "Murderous"];
		this.postfixes = ["Doom", "Death", "Destruction", "Annihilation", "Eradication", "Procrastination"];

		if (params === "random attack" || params === "random defense" || params === "random utility" || params === "random") {
